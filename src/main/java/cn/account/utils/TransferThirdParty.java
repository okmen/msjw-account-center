...
public class TransferThirdParty {
	...
	public static Map<String, Object> queryMachineInformationSheet(String applyType, String applyIdCard,String sourceOfCertification,String url,String method,String userId,String userPwd,String key) throws Exception{
		...
		logger.info("EZ1007查询结果:"+EZ1007RespJson+"。请求url:"+url+";参数："+EZ1007ReqXml+";userId:"+userId+",userPwd:"+userPwd+",key:"+key); 
		if("0000".equals(code)) {
			//成功
...
//		renewalDriverLicense("Y", "王玉璞", "A", "622822198502074110", "111", "20170712", "服兵役", "C", "", "11", "11", "22", "33", "44", "http://123.56.180.216:19002/xxfbpt/services/xxfbptservice", "xxptSchuding", "WX02", "WX02@168", "94D863D9BE7FB032E6A19430CC892610");
	...
	//	driverLicenseAnnualVerification("N", "", "622822198502074110", "", "王玉璞", "622822198502074110", "15920071829", "深圳", "1", "1", "深圳市宝安区", "111", "111", "111", "111", "111", "111", "", "", "C", "C", "http://123.56.180.216:19002/xxfbpt/services/xxfbptservice", "xxptSchuding", "WX02", "WX02@168", "94D863D9BE7FB032E6A19430CC892610");
		...
		getMyDriverLicense("430623198811056141", "C", "http://123.56.180.216:19002/xxfbpt/services/xxfbptservice", "xxptSchuding", "WX02", "WX02@168", "94D863D9BE7FB032E6A19430CC892610");
	...
	public static BaseBean informationCollection(InformationCollectionVo informationCollectionVo,  String url, String method,
		...
		try{
			...
			.append("<base64><sfzfyj>").append(informationCollectionVo.getCopyOfOwnerIdentityCard()).append("</sfzfyj></base64>")
			...
			.append("<base64><czsfzfyj>").append(informationCollectionVo.getCopyOfLegalEntityA()).append("</czsfzfyj></base64>")
			...
			.append("<gklx>").append(informationCollectionVo.getIsAttached()).append("</gklx>")
	...
	public static BaseBean informationCollection2(InformationCollection informationCollection,  String url, String method,
		...
		try{
			...
			.append("<u_sjhm>").append(informationCollection.getMobilePhone()).append("</u_sjhm>")
			.append("<openid>").append(informationCollection.getOpenId()).append("</openid>")
